---
description: Fetch a GitHub issue and implement a fix
...
- `--dry-run`: analyze and plan the fix, but don't write any code
...
If `--dry-run` was passed, describe the fix you would make and stop here.
