---
description: Onboard to a new project — understand the codebase, team conventions, and workflow
...
- `--quick` — 5-minute scan: project type, how to run, how to contribute
- `--full` (default) — comprehensive onboarding including team conventions, architecture, CI/CD
...
Skip team conventions and CI/CD sections. Output only Get Started and key commands.
