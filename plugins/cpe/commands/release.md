---
description: Cut a versioned release with changelog, tag, and GitHub release
...
If `--dry-run`: compute version, generate changelog, and show what would be created — but don't commit, tag, push, or create release.
