...
For board-level strategy memos, market analysis, business cases, or customer research reports, use `Skill(cpe:strategy-writer)` instead. It targets executive audiences with Economist/HBR-style narrative writing, evidence hierarchies, and dedicated templates.
