...
|--------|-----------|------|--------------|
| Source file path (`.ts`, `.js`, `.py`, `.go`, `.rs`, etc.) | Code comments | [references/code-comments.md](references/code-comments.md) | `@cpe:haiku` agent |
| Mentions "comments", "inline docs", "code comments" | Code comments | [references/code-comments.md](references/code-comments.md) | `@cpe:haiku` agent |
| "Clean up comments" in a folder or unstaged changes | Code comments | [references/code-comments.md](references/code-comments.md) | `@cpe:haiku` agent |
...
### Code comments (delegate to `@cpe:haiku`)
...
3. Add diagrams using `Skill(cpe:visualizing-with-mermaid)` for flows
4. Write docs in `/docs/architecture/`

For writing style and tone, use `Skill(cpe:writer)` with **The Engineer** persona.
