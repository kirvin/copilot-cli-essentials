...
For writing style, tone, and voice guidance, use `Skill(cpe:writer)` with **The Engineer** persona.
...
- `Skill(cpe:writer)` - Writing style, tone, and voice (load The Engineer persona)
- `Skill(cpe:visualizing-with-mermaid)` - Architecture and flow diagrams
