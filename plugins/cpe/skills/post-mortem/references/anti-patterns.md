...
1. Was there a skill that should have guided this correctly? (e.g., `cpe:handling-errors`, `cpe:writing-tests`)
...
- Update relevant cpe skills if they're missing guidance for this pattern
