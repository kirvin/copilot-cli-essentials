...
Load `Skill(cpe:architecting-systems)` for guidance on structure, coupling, boundaries, concurrency, and observability patterns. Use its reference files for targeted architectural context.
