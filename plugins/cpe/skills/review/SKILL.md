---
name: review
description: Use when the user wants a comprehensive code review of the current branch's changes.
---
...
- Whether to automatically fix all Critical and Important issues after the review
...
Review all changes on the current branch versus the base branch.
...
2. If the user requested auto-fix, implement all Critical and Important fixes, then re-run the review to confirm resolution
3. If auto-fix was not requested, ask the user which issues to address
