...
Use this template for product feature definitions. The output feeds into `Skill(cpe:writing-plans)` for technical task breakdown and `Skill(cpe:design)` for UI implementation.
...
### For Technical Planning (cpe:writing-plans)
