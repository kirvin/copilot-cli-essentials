---
name: sync
description: Use when the user wants to sync their fork or branch with upstream — fetching, rebasing, and resolving conflicts.
---
...
- Whether this is a fork sync (if the user mentions "fork" or an upstream remote exists)
- The target branch to sync against (default: main)
