---
name: incident
description: Use when the user is reporting or responding to an incident — triage, investigate, mitigate, and document production issues.
---
...
Assess severity immediately. Determine the incident description from the user's message.
...
Ask the user to confirm severity if it's not clear from their description.
