...
- Marking a multi-file implementation as complete (dispatch `cpe:code-reviewer` agent)
...
| Work is complete      | Code review via `cpe:code-reviewer` with no unresolved Critical issues | Self-review, "looks good to me" |
