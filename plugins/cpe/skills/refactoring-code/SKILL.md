...
**If tests are missing:** Add behavior-driven tests first using `Skill(cpe:writing-tests)`.
...
**If something breaks:** STOP. Use `Skill(cpe:systematic-debugging)`. Don't proceed until understood.
